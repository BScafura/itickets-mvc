...
namespace Tickets.Migrations
{
    ...
    [Migration("20240515203218_Usernamefullnamesadsad")]
    partial class Usernamefullnamesadsad
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "984ca3cf-0451-42ad-9bd3-d79618755eb0",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "2e9b5713-5496-4489-bad2-e4dbb5ccf5fa",
                            Name = "User1",
            ...
            modelBuilder.Entity("Tickets.Models.Filme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 3,
                            DataFim = new DateTime(2024, 5, 25, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2097),
                            DataInicio = new DateTime(2024, 5, 5, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2053),
                            MovieCategory = 4,
                            Preco = 39.5,
                            ProdutorId = 3,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 18, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2104),
                            DataInicio = new DateTime(2024, 5, 15, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2102),
                            MovieCategory = 0,
                            Preco = 29.5,
                            ProdutorId = 1,
                        ...
                        new
                        {
                            ...
                            CinemaId = 4,
                            DataFim = new DateTime(2024, 5, 22, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2108),
                            DataInicio = new DateTime(2024, 5, 15, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2106),
                            MovieCategory = 5,
                            Preco = 39.5,
                            ProdutorId = 4,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 10, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2112),
                            DataInicio = new DateTime(2024, 5, 5, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2111),
                            MovieCategory = 4,
                            Preco = 39.5,
                            ProdutorId = 2,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 13, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2116),
                            DataInicio = new DateTime(2024, 5, 5, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2115),
                            MovieCategory = 1,
                            Preco = 39.5,
                            ProdutorId = 3,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 6, 4, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2120),
                            DataInicio = new DateTime(2024, 5, 18, 21, 32, 18, 168, DateTimeKind.Local).AddTicks(2119),
                            MovieCategory = 3,
                            Preco = 39.5,
                            ProdutorId = 5,
