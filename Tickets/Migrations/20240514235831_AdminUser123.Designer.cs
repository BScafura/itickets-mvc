...
namespace Tickets.Migrations
{
    ...
    [Migration("20240514235831_AdminUser123")]
    partial class AdminUser123
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "279284e6-8fe5-47fc-b689-10af908d436c",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "3cc2f5c1-11fb-471d-9507-81c40fb1b156",
                            Name = "User1",
            ...
            modelBuilder.Entity("Tickets.Models.Filme", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CinemaId = 3,
                            DataFim = new DateTime(2024, 5, 25, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8788),
                            DataInicio = new DateTime(2024, 5, 5, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8715),
                            MovieCategory = 4,
                            Preco = 39.5,
                            ProdutorId = 3,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 18, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8795),
                            DataInicio = new DateTime(2024, 5, 15, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8794),
                            MovieCategory = 0,
                            Preco = 29.5,
                            ProdutorId = 1,
                        ...
                        new
                        {
                            ...
                            CinemaId = 4,
                            DataFim = new DateTime(2024, 5, 22, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8839),
                            DataInicio = new DateTime(2024, 5, 15, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8837),
                            MovieCategory = 5,
                            Preco = 39.5,
                            ProdutorId = 4,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 10, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8843),
                            DataInicio = new DateTime(2024, 5, 5, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8842),
                            MovieCategory = 4,
                            Preco = 39.5,
                            ProdutorId = 2,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 5, 13, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8848),
                            DataInicio = new DateTime(2024, 5, 5, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8846),
                            MovieCategory = 1,
                            Preco = 39.5,
                            ProdutorId = 3,
                        ...
                        new
                        {
                            ...
                            CinemaId = 1,
                            DataFim = new DateTime(2024, 6, 4, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8852),
                            DataInicio = new DateTime(2024, 5, 18, 0, 58, 31, 31, DateTimeKind.Local).AddTicks(8850),
                            MovieCategory = 3,
                            Preco = 39.5,
                            ProdutorId = 5,
